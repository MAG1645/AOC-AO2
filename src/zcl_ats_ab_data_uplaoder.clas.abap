CLASS zcl_ats_ab_data_uplaoder DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_ats_ab_data_uplaoder IMPLEMENTATION.
 ...
 METHOD fill_master_data.
    data : lt_bp type table of zats_ab_bpa,
           lt_prod type table of zats_ab_product.
   ...
   append value #(
    ...
    append value #(
     ...
     insert zats_ab_bpa from table @lt_bp.
  ...
  METHOD fill_transaction_data.
    data : o_rand type REF TO cl_abap_random_int,
           ...
           lv_ord_id type zats_ab_dte_id,
           lt_so type table of zats_ab_so_hdr,
           lt_so_i type table of zats_ab_so_item.
    ...
    select * from zats_ab_bpa into table @data(lt_bpa).
    select * from zats_ab_product into table @data(lt_prod).
    ...
    insert zats_ab_so_hdr from table @lt_so.
    insert zats_ab_so_item from table @lt_so_i.
